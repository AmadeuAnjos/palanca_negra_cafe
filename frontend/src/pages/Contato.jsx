  ...
  return (
    <div className="font-sans">
      <Helmet>
        ...
        <meta property="og:url" content="https://www.teudominio.pt/contact" />
        <meta property="og:image" content="https://www.teudominio.pt/images/social-contact-banner.jpg" />
        ...
        <meta name="twitter:image" content="https://www.teudominio.pt/images/social-contact-banner.jpg" />
      </Helmet>

      <section className="flex items-center justify-center">
        <div className="container mx-auto">
          <div className="relative h-96 px-4 flex items-center justify-center overflow-hidden">
            <img
      ...
      <section className="py-16 bg-gray-900">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-playfair font-bold text-center mb-12 text-white">
            Nossos Contatos
          </h2>
